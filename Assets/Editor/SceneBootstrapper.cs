...
namespace Olympus
{
    ...
    public class SceneBootstrapper
    {
        ...
        private const string k_LoadBootstrapMenu = "Olympus/Load Bootstrap Scene On Play";
        private const string k_DontLoadBootstrapMenu = "Olympus/Don't Load Bootstrap Scene On Play";
