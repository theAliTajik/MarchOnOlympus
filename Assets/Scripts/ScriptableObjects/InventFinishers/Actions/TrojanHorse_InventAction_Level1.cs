...
[CreateAssetMenu(fileName = "TrojanHorse_InventAction_Level1",  menuName = "Invent/InventAction/TrojanHorse_InventAction_Level1")]
public class TrojanHorse_InventAction_Level1 : InventAction
{
    public int Block;
    public int Damage;
