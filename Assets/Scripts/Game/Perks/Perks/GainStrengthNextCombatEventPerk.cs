...
public class GainStrengthNextCombatEventPerk : BasePerk
{

    private GainStrengthNextCombatEventPerkData m_perkData;
    
    public override void Config(BasePerkData perkData)
    {
        m_perkData = (GainStrengthNextCombatEventPerkData)perkData;
    }
