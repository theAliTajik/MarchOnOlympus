...
public class Warrior1 : BaseEnemy
{
    #region Animations
    ...
    [SerializeField] private Warrior1MovesData m_data;
        ...
        switch (m_nextMove.clientID)
        {
            case "Block":
				...
				foreach (Fighter i in enemies)
					GameActionHelper.AddMechanicToFighter(i, m_data.Move1Block, MechanicType.BLOCK);
				break;
            case "Hit":
                m_animation.Play(ANIM_ATTACK_COMONWARRIOR, finishCallback);
				yield return new WaitForSeconds(1f);
