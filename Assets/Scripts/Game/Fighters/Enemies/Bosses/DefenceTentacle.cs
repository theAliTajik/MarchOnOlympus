...
public class DefenceTentacle : BaseEnemy
{
    #region Animations
    ...
    [SerializeField] private DefenceTentacleMovesData m_data;
    ...
    protected override void OnDeath()
    {
		...
		//----------- boss gains 5 dex -----------
		//GameActionHelper.AddMechanicToFighter(->BOSS, m_data.DeadDexterity, MechanicType.DEXTERITY);
	}
