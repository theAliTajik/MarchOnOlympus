...
public class ChaosTentacle : BaseEnemy
{
    #region Animations
    ...
    [SerializeField] private ChaosTentacleMovesData m_data;
    ...
    private IEnumerator WaitAndExecute(Action finishCallback)
    {
		...
		switch (m_nextMove.clientID)
        {
			case "Energy":
				...
				//When alive, Gives +2 energy to PLAYER but whenever player uses a card, gives +1 str or dex to the boss
				break;
		}
