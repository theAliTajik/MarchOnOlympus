...
public class AttackTentacle : BaseEnemy
{
    #region Animations
    ...
    [SerializeField] private AttackTentacleMovesData m_data;
    ...
    protected override void OnDeath()
    {
		...
		//----------- boss gains 5 str -----------
		//GameActionHelper.AddMechanicToFighter(->BOSS, m_data.DeadStr, MechanicType.STRENGTH);
	}
